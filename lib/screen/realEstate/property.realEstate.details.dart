...
if (bathroomsController.text.trim().isEmpty || bathrooms == null || bathrooms <= 0) {
Fluttertoast.showToast(
...
if (bedroomsController.text.trim().isEmpty || bedrooms == null || bedrooms <= 0) {
Fluttertoast.showToast(
...
items: furnitureList,
value: furnishing,
onChange: isUpdateMode ? null : (value) => ref.read(furnishingProvider.notifier).state = value,
),
SizedBox(height: 15.h),
_buildLabel("Area (sqft)"),
SizedBox(height: 10.h),
