  ...
  static Future<void> login(
    ...
    try {
      ...
      if (e.response?.statusCode == 403) {
        ...
        Fluttertoast.showToast(
          msg: e.response?.data['message'] ?? 'Your profile is under review. Please wait for approval.',
      ...
      RegisterRequest(
        ...
        password: password,
         ...
         phone:phone,
          age:age,
         gender:gender,
          dateOfBirth:date_of_birth, role: ''
      ),
    );
...
*/
  ...
  BuildContext context,
    ...
    if (response.response.statusCode == 200 || response.response.statusCode == 201) {
      ...
      Navigator.push(context, CupertinoPageRoute(builder: (context) => const BasicInfoScreen()),);
      Fluttertoast.showToast(
        msg: response.response.data['message'],
        toastLength: Toast.LENGTH_SHORT,
        gravity: ToastGravity.TOP,
