...
import '../models/MatchProfileModel.dart';

final matchProfileBasedProvider = FutureProvider.autoDispose<MatchProfileModel>((ref) async {
  ...
  try {
    final response = await service.getMatches(userId.toString());
    ...
    Fluttertoast.showToast(msg: "NearBy API Error");
