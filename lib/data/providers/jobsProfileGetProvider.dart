...
import '../models/JobsProfileGetModel.dart';

final jobProfileDataProvider = FutureProvider.autoDispose<JobsProfileGetModel>((ref) async {
  ...
  try {
    final response = await service.getJobsProfile(userId.toString());
