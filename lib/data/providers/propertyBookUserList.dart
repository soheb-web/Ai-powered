import 'package:ai_powered_app/data/models/PropertyAgentUserModel.dart';
...
final propertyBookUserListProvider = FutureProvider.autoDispose<PropertyAgentUserModel>((ref) async {
  ...
  try {
    final response = await service.getPropertyBookList(userId.toString());
